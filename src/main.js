...
function pushToLine(groupId, messages) {
...
function onButtonClick() {
    ...
    const lastColumn = targetSheet === null || targetSheet === void 0 ? void 0 : targetSheet.getLastColumn();
    ...
    filteredData.forEach(item => {
        targetSheet === null || targetSheet === void 0 ? void 0 : targetSheet.getRange(item.rowIndex, 13).setValue(true);
    });
}
// LINEでグループにpush通知するプログラムここまで
// スプレッドシートからデータを取得
function getDatum(sheetName) {
    var _a;
    const ss = SpreadsheetApp.getActiveSpreadsheet();
    const targetSheet = ss.getSheetByName(sheetName);
    const lastRow = targetSheet === null || targetSheet === void 0 ? void 0 : targetSheet.getRange(2, 2).getNextDataCell(SpreadsheetApp.Direction.DOWN).getRow();
    const lastColumn = targetSheet === null || targetSheet === void 0 ? void 0 : targetSheet.getLastColumn();
    if (!lastRow || lastRow < 4)
        return [];
    const allData = targetSheet === null || targetSheet === void 0 ? void 0 : targetSheet.getRange(4, 2, lastRow - 3, 4).getValues();
    return (_a = allData === null || allData === void 0 ? void 0 : allData.map((row, index) => ({
        ...
        "店舗名": row[2],
        "連絡内容": row[3],
        "送信チェック": targetSheet === null || targetSheet === void 0 ? void 0 : targetSheet.getRange(index + 4, lastColumn).getValue(),
